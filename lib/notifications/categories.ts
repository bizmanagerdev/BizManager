...
const MONEY = new Set([
  "document_unlinked_money","collection_overdue", "check_deposit_due", "payment_due_today", "payment_outflow_due", "recurring_payment_reminder", "salary_payment_reminder", "loan_installment_reminder", "card_charge_upcoming", "promise_broken", "recurring_expense_confirm"]);
...
const OPS = new Set(["low_stock", "unprocessed_items", "vehicle_expiry", "document_expiry"]);
