...
//
// The h-10/w-10 box is deliberate and shared — every control on the bar (icons,
// the +, the avatar) is the same 40px square, so they align on one line.
//
...
export const TOPBAR_ICON_BUTTON =
  "group h-10 w-10 rounded-full !bg-transparent !border-transparent !shadow-none !text-sidebar-foreground transition-all hover:!bg-secondary hover:!text-secondary-foreground hover:scale-110";
