...
import { DebtorsTable, DueTodaySection } from "@/app/(app)/collections/CollectionsClient.ui";
  ...
  return (
    <div className="space-y-4">
      {pendingDueToday.length > 0 ? (
        <DueTodaySection dueToday={pendingDueToday} collectingId={collectingId} onCollect={markCollected} />
      ) : null}
