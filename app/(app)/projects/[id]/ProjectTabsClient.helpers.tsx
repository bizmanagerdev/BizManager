...
import { isGeneratedRecurringExpense } from "@/lib/expenses";
...
export function expenseRecordedByLabel(item: ExpenseListItem, {
  ...
  // Generated by the recurring rule: recorded_by is the template's author, who
  // never entered this bill. Someone who marked it paid themselves is stamped
  // as themselves, and is still named.
  const templateId = getString(item.expense, "recurring_expense_template_id");
  if (isGeneratedRecurringExpense({ recurringTemplateId: templateId, recordedBy: recordedByValue }, templateId ? recurringTemplateAuthors[templateId] : null)) {
    return "נוצר אוטומטית";
  }
